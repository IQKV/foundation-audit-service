...
import com.iqkv.foundation.auditservice.infrastructure.config.AuthConfigurationProperties;
import com.iqkv.foundation.auditservice.tenancy.TenantExtractionFilter;
...
/**
 * Web security configuration for the Audit Service.
 *
 * <p>Configures the service as an OAuth2 Resource Server using JWTs signed with a public RSA key.
 * Disables CSRF, CORS (handled by Gateway), and session management (stateless).
 */
@Configuration
@EnableWebSecurity
